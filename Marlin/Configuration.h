...
#define STRING_CONFIG_H_AUTHOR "(thisiskeithb (modified by FullMetal_Dev), BIQU B1 BLTouch)" // Who made the changes.
...
#define CUSTOM_MACHINE_NAME "BIQU B1 (FullMetal_Dev UBL Dual_Z)"
...
#define Z2_DRIVER_TYPE TMC2208  // TMC2225
